...
#To execute:
#./az-kv-sec-copy.sh ../az-resource-params/data-access /Users/Martin/Development/goldenProjects/GoodFriends_lesson_branches/Configuration/Configuration.csproj
