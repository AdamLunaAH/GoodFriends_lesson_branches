...
#To execute:
#./az-read-resource-params.sh ./az-resource-params/data-access /Users/Martin/Development/goldenProjects/GoodFriends_lesson_branches/Configuration/Configuration.csproj
