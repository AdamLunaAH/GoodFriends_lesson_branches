...
# Usage:
# .\az-read-resource-params.ps1 ./az-resource-params/data-access "C:\Users\Martin\Development\goldenProjects\GoodFriends_lesson_branches\Configuration\Configuration.csproj"
